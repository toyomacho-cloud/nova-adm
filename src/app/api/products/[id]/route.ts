...
// Cargos permitidos para editar/eliminar productos
...
export async function PATCH(
    ...
    try {
        ...
        // Verificar cargo para editar productos
        ...
        if (!CARGOS_GESTIONAR_PRODUCTOS.includes(cargoUsuario)) {
            ...
            return NextResponse.json(
                {
                    error: `Acceso denegado. Tu cargo de ${nombreCargo} no permite editar productos.`,
